...
_gmic()
{
    ...
    case "${prev}" in
        ...
        "font" | "-font" | "+font")
            COMPREPLY=( $(compgen -W "> {_\'Font_name\'_|_font_number_|_font.gmz_},_font_height[%]>0,_is_bold={_0_|_1_}") ); return 0;;
        ...
        "label_fg" | "-label_fg" | "+label_fg")
            COMPREPLY=( $(compgen -W "> tolerance>=0,is_high_connectivity={_0_|_1_},_is_L2_norm={_0_|_1_}") ); return 0;;
        ...
        "matchpatch" | "-matchpatch" | "+matchpatch")
            COMPREPLY=( $(compgen -W "> [patch_image],patch_width>=1,_patch_height>=1,_patch_depth>=1,_nb_iterations>=0,_nb_randoms>=0,_occurence_penalization,_output_score={_0_|_1_},_[guide]") ); return 0;;
        "matchpatch_alt" | "-matchpatch_alt" | "+matchpatch_alt")
            COMPREPLY=( $(compgen -W "> [patch_image],_patch_width>=1,_patch_height>=1,_patch_depth>=1,_nb_iterations>=0,_nb_randoms>=0,_occurrence_penalization>=0,_output_score={_0_|_1_},_[guide]") ); return 0;;
        "max" | "-max" | "+max")
            COMPREPLY=( $(compgen -W "value[%] [image] \'formula\' (no_arg)") ); return 0;;
        ...
        "nn_conv2d" | "-nn_conv2d" | "+nn_conv2d")
            COMPREPLY=( $(compgen -W "> out,in,nb_channels>0,_kernel_size>0,_stride>0,_dilation,_shrink>=0,_boundary_conditions,_learning_mode,_regularization>=0,_initialization") ); return 0;;
        "nn_conv2dnl" | "-nn_conv2dnl" | "+nn_conv2dnl")
            COMPREPLY=( $(compgen -W "> out,in,nb_channels>0,_kernel_size>0,_stride>0,_dilation,_shrink>=0,_boundary_conditions,_activation,_learning_mode,regularization>=0,_initialization") ); return 0;;
        "nn_conv2dnnl" | "-nn_conv2dnnl" | "+nn_conv2dnnl")
            COMPREPLY=( $(compgen -W "> out,in,nb_channels>0,_kernel_size>0,_stride>0,_dilation,_shrink>=0,_boundary_conditions,_activation,_learning_mode,_regularization>=0,_initialization") ); return 0;;
        "nn_conv3d" | "-nn_conv3d" | "+nn_conv3d")
            COMPREPLY=( $(compgen -W "> out,in,nb_channels>0,_kernel_size>0,_stride>0,_dilation,_shrink>=0,_boundary_conditions,_learning_mode,_regularization>=0,_initialization") ); return 0;;
        "nn_conv3dnl" | "-nn_conv3dnl" | "+nn_conv3dnl")
            COMPREPLY=( $(compgen -W "> out,in,nb_channels>0,_kernel_size>0,_stride>0,_dilation>0,_shrink>=0,_boundary_conditions,_activation,_learning_mode,_regularization>=0,_initialization") ); return 0;;
        ...
        "nn_fc" | "-nn_fc" | "+nn_fc")
            COMPREPLY=( $(compgen -W "> out,in,nb_channels>0,_learning_mode,_regularization>=0,_initialization") ); return 0;;
        "nn_fcnl" | "-nn_fcnl" | "+nn_fcnl")
            COMPREPLY=( $(compgen -W "> out,in,nb_channels>0,_activation,_learning_mode,_regularization>=0,_initialization") ); return 0;;
        ...
        "nn_normalize" | "-nn_normalize" | "+nn_normalize")
            COMPREPLY=( $(compgen -W "> out,_in,_normalization_mode,_learning_mode") ); return 0;;
        ...
        "nn_resconv2dnl" | "-nn_resconv2dnl" | "+nn_resconv2dnl")
            COMPREPLY=( $(compgen -W "> out,_in,_kernel_size>0,_dilation>0,_boundary_conditions,_activation,_learning_mode,_regularization>=0") ); return 0;;
        "nn_resconv3dnl" | "-nn_resconv3dnl" | "+nn_resconv3dnl")
            COMPREPLY=( $(compgen -W "> out,_in,_kernel_size>0,_dilation>0,_boundary_conditions,_activation,_learning_mode,_regularization>=0") ); return 0;;
        "nn_resfcnl" | "-nn_resfcnl" | "+nn_resfcnl")
            COMPREPLY=( $(compgen -W "> out,_in,_activation,_learning_mode,_regularization>=0") ); return 0;;
        ...
        "nn_sub" | "-nn_sub" | "+nn_sub")
            COMPREPLY=( $(compgen -W "> out,in0,_in1") ); return 0;;
        "nn_tconv2d" | "-nn_tconv2d" | "+nn_tconv2d")
            COMPREPLY=( $(compgen -W "> out,in,nb_channels>0,_kernel_size>0,_stride>0,_dilation,_shrink>=0,_boundary_conditions,_learning_mode,_regularization>=0,_initialization") ); return 0;;
        "nn_tconv2dnl" | "-nn_tconv2dnl" | "+nn_tconv2dnl")
            COMPREPLY=( $(compgen -W "> out,in,nb_channels>0,_kernel_size>0,_stride>0,_dilation,_shrink>=0,_boundary_conditions,_activation,_learning_mode,_regularization>=0,_initialization") ); return 0;;
        "nn_trainer" | "-nn_trainer" | "+nn_trainer")
            COMPREPLY=( $(compgen -W "> out,_in,_learning_rate>0,_optimizer,_scheduler") ); return 0;;
        "noise" | "-noise" | "+noise")
        ...
        "projections3d" | "-projections3d" | "+projections3d")
            COMPREPLY=( $(compgen -W "> _x[%],_y[%],_z[%],_is_bounding_box={_0_|_1_},nb_subdivisions>0") ); return 0;;
        ...
        "warp_patch" | "-warp_patch" | "+warp_patch")
            COMPREPLY=( $(compgen -W "> [displacement_map],patch_width>=1,_patch_height>=1,_patch_depth>=1,_std_factor>0,_boundary_conditions,_fast_approximation={_0_|_1_}") ); return 0;;
