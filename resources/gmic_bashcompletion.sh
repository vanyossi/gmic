...
_gmic()
{
    ...
    case "${prev}" in
        ...
        "abscut" | "-abscut" | "+abscut")
            COMPREPLY=( $(compgen -W "> min,_max,_offset") ); return 0;;
        "ac" | "-ac" | "+ac")
        ...
        "animate" | "-animate" | "+animate")
            COMPREPLY=( $(compgen -W "filter_name,\"param1_start,...,paramN_start\",\"param1_end,...,paramN_end\",nb_frames>=0,_output_frames={_0:No_|_1:Yes_},_output_filename delay>0,_back_and_forth={_0:No_|_1:Yes_}") ); return 0;;
        "ap" | "-ap" | "+ap")
        ...
        "apply_mask" | "-apply_mask" | "+apply_mask")
            COMPREPLY=( $(compgen -W "> \"command\",[opacity_mask],_max_opacity_mask") ); return 0;;
        ...
        "area" | "-area" | "+area")
            COMPREPLY=( $(compgen -W "> tolerance>=0,is_high_connectivity={_0:No_|_1:Yes_}") ); return 0;;
        "area_fg" | "-area_fg" | "+area_fg")
            COMPREPLY=( $(compgen -W "> tolerance>=0,is_high_connectivity={_0:No_|_1:Yes_}") ); return 0;;
        "arg0" | "-arg0" | "+arg0")
            COMPREPLY=( $(compgen -W "> n>=0,_arg_0,...,_arg_N") ); return 0;;
        "arg1" | "-arg1" | "+arg1")
            COMPREPLY=( $(compgen -W "> n>=1,_arg_1,...,_arg_N") ); return 0;;
        ...
        "array_mirror" | "-array_mirror" | "+array_mirror")
            COMPREPLY=( $(compgen -W "> N>=0,_dir={_0:X_|_1:Y_|_2:XY_|_3:Tri-XY_},_expand_type={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "at" | "-at" | "+at")
            COMPREPLY=( $(compgen -W "> \"command\",_tile_width[%]>0,_tile_height[%]>0,_tile_depth[%]>0,_overlap_width[%]>=0,_overlap_height[%]>=0,_overlap_depth[%]>=0,_boundary_conditions={_0:Dirichlet_|_1:Neumann_|_2:Periodic_|_3:Mirror_}") ); return 0;;
        "at_curve" | "-at_curve" | "+at_curve")
            COMPREPLY=( $(compgen -W "> x0[%],y0[%],z0[%],...,xN[%],yn[%],zn[%]") ); return 0;;
        ...
        "autocrop_components" | "-autocrop_components" | "+autocrop_components")
            COMPREPLY=( $(compgen -W "> _threshold[%],_min_area[%]>=0,_is_high_connectivity={_0:No_|_1:Yes_},_output_type={_0:Crop_|_1:Segmentation_|_2:Coordinates_}") ); return 0;;
        ...
        "ball" | "-ball" | "+ball")
            COMPREPLY=( $(compgen -W "> _size>0,_R,_G,_B,_ambient>=0,_diffuse>=0,_specular>=0,_shininess>=0,_light_x,_light_y,_light_z") ); return 0;;
        ...
        "blend_seamless" | "-blend_seamless" | "+blend_seamless")
            COMPREPLY=( $(compgen -W "> _is_mixed_mode={_0:No_|_1:Yes_},_inner_fading[%]>=0,_outer_fading[%]>=0") ); return 0;;
        "blur" | "-blur" | "+blur")
            COMPREPLY=( $(compgen -W "std_deviation[%]>=0,_boundary_conditions,_kernel axes,std_deviation[%]>=0,_boundary_conditions,_kernel") ); return 0;;
        ...
        "blur_bloom" | "-blur_bloom" | "+blur_bloom")
            COMPREPLY=( $(compgen -W "> _amplitude>=0,_ratio>=0,_nb_iter>=0,_blend_operator={_+_|_max_|_min_},_kernel={_0:Deriche_|_1:Gaussian_|_2:Box_|_3:Triangle_|_4:Quadratic_},_normalize_scales={_0:No_|_1:Yes_},_axes") ); return 0;;
        ...
        "brightness" | "-brightness" | "+brightness")
            COMPREPLY=( $(compgen -W "> strength") ); return 0;;
        ...
        "cat" | "-cat" | "+cat")
            COMPREPLY=( $(compgen -W "> filename,_display_line_numbers={_0:No_|_1:Yes_},_line_selection,") ); return 0;;
        ...
        "check3d" | "-check3d" | "+check3d")
            COMPREPLY=( $(compgen -W "> _is_full_check={_0:No_|_1:Yes_}") ); return 0;;
        "check" | "-check" | "+check")
        ...
        "circles3d" | "-circles3d" | "+circles3d")
            COMPREPLY=( $(compgen -W "> _radius>=0,_is_outlined={_0:No_|_1:Yes_}") ); return 0;;
        "close_binary" | "-close_binary" | "+close_binary")
            COMPREPLY=( $(compgen -W "> 0<=_endpoint_rate<=100,_endpoint_connectivity>=0,_spline_distmax>=0,_segment_distmax>=0,0<=_spline_anglemax<=180,_spline_roundness>=0,_area_min>=0,_allow_self_intersection={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "closing_circ" | "-closing_circ" | "+closing_circ")
            COMPREPLY=( $(compgen -W "> _size>=0,_is_real={_0:No_|_1:Yes_}") ); return 0;;
        "clut" | "-clut" | "+clut")
        ...
        "colorcube3d" | "-colorcube3d" | "+colorcube3d")
            COMPREPLY=( $(compgen -W "> _is_wireframe={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "command" | "-command" | "+command")
            COMPREPLY=( $(compgen -W "> _add_debug_info={_0:No_|_1:Yes_},{_filename_|_http[s]://URL_|_\"string\"_}") ); return 0;;
        "compose_channels" | "-compose_channels" | "+compose_channels")
            COMPREPLY=( $(compgen -W "> _operator") ); return 0;;
        ...
        "compress_rle" | "-compress_rle" | "+compress_rle")
            COMPREPLY=( $(compgen -W "> _is_binary_data={_0:No_|_1:Yes_},_maximum_sequence_length>=0") ); return 0;;
        ...
        "convolve" | "-convolve" | "+convolve")
            COMPREPLY=( $(compgen -W "> [mask],_boundary_conditions,_is_normalized={_0:No_|_1:Yes_},_channel_mode,_xcenter,_ycenter,_zcenter,_xstride>0,_ystride>0,_zstride>0,_xdilation,_ydilation,_zdilation,_xoffset,_yoffset,_zoffset,_xsize>=0,_ysize>=0,_zsize>=0") ); return 0;;
        ...
        "cracks" | "-cracks" | "+cracks")
            COMPREPLY=( $(compgen -W "> 0<=_density<=100,_is_relief={_0:No_|_1:Yes_},_opacity,_color1,...") ); return 0;;
        "createdir" | "-createdir" | "+createdir")
            COMPREPLY=( $(compgen -W "> force_overwrite={_0:No_|_1:Yes_},directory_path_1,_directory_path_2,...") ); return 0;;
        "crop" | "-crop" | "+crop")
        ...
        "curve3d" | "-curve3d" | "+curve3d")
            COMPREPLY=( $(compgen -W "_\"x(t)\",_\"y(t)\",_\"z(t)\",_\"r(t)\",_resolution>1,_tmin,_tmax,_nb_sides>=0,_cap_style={_0:Open_|_1 Capped_|_2 Closed_}") ); return 0;;
        "curve" | "-curve" | "+curve")
        ...
        "db3d" | "-db3d" | "+db3d")
            COMPREPLY=( $(compgen -W "> _is_double_sided={_0:No_|_1:Yes_}") ); return 0;;
        "dclut" | "-dclut" | "+dclut")
        ...
        "denoise" | "-denoise" | "+denoise")
            COMPREPLY=( $(compgen -W "[guide],std_deviation_s[%]>=0,std_deviation_r[%]>=0,_patch_size>0,_lookup_size>0,_smoothness,_fast_approx={_0:No_|_1:Yes_} std_deviation_s[%]>=0,std_deviation_r[%]>=0,_patch_size>0,_lookup_size>0,_smoothness,_fast_approx={_0:No_|_1:Yes_}") ); return 0;;
        "denoise_cnn" | "-denoise_cnn" | "+denoise_cnn")
            COMPREPLY=( $(compgen -W "> _noise_level>=0,_patch_size>0") ); return 0;;
        ...
        "depthmap3d" | "-depthmap3d" | "+depthmap3d")
            COMPREPLY=( $(compgen -W "> [object3d],_x[%],_y[%],_z_,is_double_sided={_0:No_|_1:Yes_},_is_zbuffer={_0:No_|_1:Yes_},_focale") ); return 0;;
        ...
        "dh" | "-dh" | "+dh")
            COMPREPLY=( $(compgen -W "> _width>=0,_height>=0,_clusters>0,_min_value[%],_max_value[%],_show_axes={_0:No_|_1:Yes_},_expression.") ); return 0;;
        "diffusiontensors" | "-diffusiontensors" | "+diffusiontensors")
            COMPREPLY=( $(compgen -W "> _sharpness>=0,0<=_anisotropy<=1,_alpha[%],_sigma[%],is_sqrt={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "dilate_circ" | "-dilate_circ" | "+dilate_circ")
            COMPREPLY=( $(compgen -W "> _size[%]>=0,_boundary_conditions,_is_real={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "displacement" | "-displacement" | "+displacement")
            COMPREPLY=( $(compgen -W "> [reference],_smoothness>=0,_precision>=0,_nb_scales>=0,_iteration_max>=0,mode={_0:Backward_|_1:Forward_},_[guide]") ); return 0;;
        ...
        "display_parametric" | "-display_parametric" | "+display_parametric")
            COMPREPLY=( $(compgen -W "> _width>0,_height>0,_outline_opacity,_vertex_radius>=0,_is_antialiased={_0:No_|_1:Yes_},_is_decorated={_0:No_|_1:Yes_},_xlabel,_ylabel") ); return 0;;
        ...
        "drop_shadow" | "-drop_shadow" | "+drop_shadow")
            COMPREPLY=( $(compgen -W "> _offset_x[%],_offset_y[%],_smoothness[%]>=0,_curvature_x,_curvature_y,_expand_size={_0:No_|_1:Yes_}") ); return 0;;
        "drop_shadow" | "-drop_shadow" | "+drop_shadow")
            COMPREPLY=( $(compgen -W "> _offset_x[%],_offset_y[%],_smoothness[%]>=0,curvature_x>=0,curvature_y>=0,_expand_size={_0:No_|_1:Yes_},_output_separate_layers={_0:No_|_1:Yes_}") ); return 0;;
        "dt" | "-dt" | "+dt")
            COMPREPLY=( $(compgen -W "> _size_factor>0,_ellipse_size>=0,_color_mode={_0:Monochrome_|_1:Grayscale_|_2:Color_},_outline>=0") ); return 0;;
        "dw" | "-dw" | "+dw")
            COMPREPLY=( $(compgen -W "> _cell_size>0") ); return 0;;
        ...
        "edgels" | "-edgels" | "+edgels")
            COMPREPLY=( $(compgen -W "> x0,y0,_n0,_is_high_connectivity={_0:No_|_1:Yes_}") ); return 0;;
        "edges" | "-edges" | "+edges")
            COMPREPLY=( $(compgen -W "> _threshold[%]>=0") ); return 0;;
        "elevate" | "-elevate" | "+elevate")
            COMPREPLY=( $(compgen -W "> _depth,_is_plain={_0:No_|_1:Yes_},_is_colored={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "exec" | "-exec" | "+exec")
            COMPREPLY=( $(compgen -W "> _is_verbose={_0:No_|_1:Yes_},\"command\"") ); return 0;;
        ...
        "extract_region" | "-extract_region" | "+extract_region")
            COMPREPLY=( $(compgen -W "> [label_image],_extract_xyz_coordinates={_0:No_|_1:Yes_},_label_1,...,_label_M") ); return 0;;
        ...
        "fitscreen" | "-fitscreen" | "+fitscreen")
            COMPREPLY=( $(compgen -W "width,height,_minimal_size[%]>0,_maximal_size[%]>0 [image],_minimal_size[%]>0,_maximal_size[%]>0") ); return 0;;
        "flood" | "-flood" | "+flood")
            COMPREPLY=( $(compgen -W "> x[%],_y[%],_z[%],_tolerance>=0,_is_high_connectivity={_0:No_|_1:Yes_},_opacity,_color1,...") ); return 0;;
        ...
        "font2gmz" | "-font2gmz" | "+font2gmz")
            COMPREPLY=( $(compgen -W "> _font_name,_font_size>0,_font_qualifier") ); return 0;;
        "font" | "-font" | "+font")
            COMPREPLY=( $(compgen -W "> {_\'Font_name\'_|_font_number_|_font.gmz_},_font_height[%]>0,_is_bold={_0:No_|_1:Yes_}") ); return 0;;
        "fontchart" | "-fontchart" | "+fontchart")
            COMPREPLY=( $(compgen -W "> display_mode.") ); return 0;;
        "for" | "-for" | "+for")
            COMPREPLY=( $(compgen -W "> condition") ); return 0;;
        "fov3d" | "-fov3d" | "+fov3d")
        ...
        "frame_pattern" | "-frame_pattern" | "+frame_pattern")
            COMPREPLY=( $(compgen -W "M>=3,_constrain_size={_0:No_|_1:Yes_} M>=3,_[frame_image],_constrain_size={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "gradient2rgb" | "-gradient2rgb" | "+gradient2rgb")
            COMPREPLY=( $(compgen -W "> _is_orientation={_0:No_|_1:Yes_}") ); return 0;;
        "gradient" | "-gradient" | "+gradient")
            COMPREPLY=( $(compgen -W "{_x_|_y_|_z_|_c_}...{_x_|_y_|_z_|_c_},_scheme,_boundary_conditions (no_arg)") ); return 0;;
        "gradient_norm" | "-gradient_norm" | "+gradient_norm")
            COMPREPLY=( $(compgen -W "_scheme,_boundary_conditions (no_arg)") ); return 0;;
        ...
        "hardsketchbw" | "-hardsketchbw" | "+hardsketchbw")
            COMPREPLY=( $(compgen -W "> _amplitude>=0,_density>=0,_opacity,0<=_edge_threshold<=100,_is_fast={_0:No_|_1:Yes_}") ); return 0;;
        "hearts" | "-hearts" | "+hearts")
            COMPREPLY=( $(compgen -W "> _density>=0") ); return 0;;
        "heat_flow" | "-heat_flow" | "+heat_flow")
            COMPREPLY=( $(compgen -W "> _nb_iter>=0,_dt,_keep_sequence={_0:No_|_1:Yes_}") ); return 0;;
        "help" | "-help" | "+help")
            COMPREPLY=( $(compgen -W "$coms" -- "$cur") ); return 0;;
        ...
        "histogram_cumul" | "-histogram_cumul" | "+histogram_cumul")
            COMPREPLY=( $(compgen -W "> _nb_levels>0,_is_normalized={_0:No_|_1:Yes_},_val0[%],_val1[%]") ); return 0;;
        ...
        "histogram_pointwise" | "-histogram_pointwise" | "+histogram_pointwise")
            COMPREPLY=( $(compgen -W "> nb_levels[%]>0,_value0[%],_value1[%]") ); return 0;;
        "hough" | "-hough" | "+hough")
            COMPREPLY=( $(compgen -W "> _width>0,_height>0,gradient_norm_voting={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "ib" | "-ib" | "+ib")
            COMPREPLY=( $(compgen -W "> filename") ); return 0;;
        "icp" | "-icp" | "+icp")
            COMPREPLY=( $(compgen -W "> [reference],_affine_mode,_precision>0,_iter_max>=0") ); return 0;;
        "idct" | "-idct" | "+idct")
            COMPREPLY=( $(compgen -W "_{_x_|_y_|_z_}...{_x_|_y_|_z_} (no_arg)") ); return 0;;
        ...
        "imagealpha" | "-imagealpha" | "+imagealpha")
        ...
        "img2base64" | "-img2base64" | "+img2base64")
            COMPREPLY=( $(compgen -W "> _encoding={_0:Base64_|_1:Base64url_},_store_names={_0:No_|_1:Yes_}") ); return 0;;
        "img2patches" | "-img2patches" | "+img2patches")
            COMPREPLY=( $(compgen -W "> patch_size>0,_overlap[%]>0,_boundary_conditions") ); return 0;;
        "in" | "-in" | "+in")
            COMPREPLY=( $(compgen -W "> filename") ); return 0;;
        "index" | "-index" | "+index")
            COMPREPLY=( $(compgen -W "> {_[palette]_|_palette_name_},0<=_dithering<=1,_map_colors={_0:No_|_1:Yes_}") ); return 0;;
        "indexof" | "-indexof" | "+indexof")
            COMPREPLY=( $(compgen -W "> string,_arg_0,...,_arg_N") ); return 0;;
        "inpaint" | "-inpaint" | "+inpaint")
            COMPREPLY=( $(compgen -W "[mask] [mask],0,_fast_method [mask],_patch_size>=1,_lookup_size>=1,_lookup_factor>=0,_lookup_increment!=0,_blend_size>=0,0<=_blend_threshold<=1,_blend_decay>=0,_blend_scales>=1,_is_blend_outer={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "inpaint_holes" | "-inpaint_holes" | "+inpaint_holes")
            COMPREPLY=( $(compgen -W "> maximal_area[%]>=0,_tolerance>=0,_is_high_connectivity={_0:No_|_1:Yes_}") ); return 0;;
        "inpaint_matchpatch" | "-inpaint_matchpatch" | "+inpaint_matchpatch")
            COMPREPLY=( $(compgen -W "> [mask],_nb_scales={_0:Auto_|_>0_},_patch_size>0,_nb_iterations_per_scale>0,_blend_size>=0,_allow_outer_blending={_0:No_|_1:Yes_},_is_already_initialized={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "j3d" | "-j3d" | "+j3d")
            COMPREPLY=( $(compgen -W "> [object3d],_x[%],_y[%],_z,_opacity,_rendering_mode,_is_double_sided={_0:No_|_1:Yes_},_is_zbuffer={_0:No_|_1:Yes_},_focale,_light_x,_light_y,_light_z,_specular_lightness,_specular_shininess,_is_multithreaded_rendering={_0:No_|_1:Yes_}") ); return 0;;
        "j" | "-j" | "+j")
            COMPREPLY=( $(compgen -W "> [sprite],_x[%|~],_y[%|~],_z[%|~],_c[%|~],_opacity,_[opacity_mask],_max_opacity_mask") ); return 0;;
        "ja" | "-ja" | "+ja")
            COMPREPLY=( $(compgen -W "> [sprite],_x[%|~],_y[%|~],_z[%|~],_c[%|~],_opacity") ); return 0;;
        ...
        "label" | "-label" | "+label")
            COMPREPLY=( $(compgen -W "> _tolerance>=0,is_high_connectivity={_0:No_|_1:Yes_},_is_L2_norm={_0:No_|_1:Yes_}") ); return 0;;
        "label_fg" | "-label_fg" | "+label_fg")
            COMPREPLY=( $(compgen -W "> tolerance>=0,is_high_connectivity={_0:No_|_1:Yes_},_is_L2_norm={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "light_relief" | "-light_relief" | "+light_relief")
            COMPREPLY=( $(compgen -W "> _ambient_light,_specular_lightness,_specular_size,_darkness,_light_smoothness,_xl,_yl,_zl,_zscale,_opacity_is_heightmap={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "mandelbrot" | "-mandelbrot" | "+mandelbrot")
            COMPREPLY=( $(compgen -W "> z0r,z0i,z1r,z1i,_iteration_max>=0,_is_julia={_0:No_|_1:Yes_},_c0r,_c0i,_opacity") ); return 0;;
        "map" | "-map" | "+map")
        ...
        "match_rgb" | "-match_rgb" | "+match_rgb")
            COMPREPLY=( $(compgen -W "> [reference],_gamma>=0,_regularization>=0,_luminosity_constraints>=0,_rgb_resolution>=0,_is_constraints={_0:No_|_1:Yes_}") ); return 0;;
        "matchpatch" | "-matchpatch" | "+matchpatch")
            COMPREPLY=( $(compgen -W "> [patch_image],patch_width>=1,_patch_height>=1,_patch_depth>=1,_nb_iterations>=0,_nb_randoms>=0,_occurence_penalization,_output_score={_0:No_|_1:Yes_},_[guide]") ); return 0;;
        "matchpatch_alt" | "-matchpatch_alt" | "+matchpatch_alt")
            COMPREPLY=( $(compgen -W "> [patch_image],_patch_width>=1,_patch_height>=1,_patch_depth>=1,_nb_iterations>=0,_nb_randoms>=0,_occurrence_penalization>=0,_output_score={_0:No_|_1:Yes_},_[guide]") ); return 0;;
        "max" | "-max" | "+max")
            COMPREPLY=( $(compgen -W "value[%] [image] \'formula\' (no_arg)") ); return 0;;
        ...
        "median_files" | "-median_files" | "+median_files")
            COMPREPLY=( $(compgen -W "> \"filename_pattern\",_first_frame>=0,_last_frame={_>=0_|_-1:Last_},_frame_step>=1,_frame_rows[%]>=1,_is_fast_approximation={_0:No_|_1:Yes_}") ); return 0;;
        "median_video" | "-median_video" | "+median_video")
            COMPREPLY=( $(compgen -W "> video_filename,_first_frame>=0,_last_frame={_>=0_|_-1:Last_},_frame_step>=1,_frame_rows[%]>=1,_is_fast_approximation={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "minimal_path" | "-minimal_path" | "+minimal_path")
            COMPREPLY=( $(compgen -W "> x0[%]>=0,y0[%]>=0,z0[%]>=0,x1[%]>=0,y1[%]>=0,z1[%]>=0,_is_high_connectivity={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "mt3d" | "-mt3d" | "+mt3d")
            COMPREPLY=( $(compgen -W "> _is_multi_threaded_rendering={_0:No_|_1:Yes_}") ); return 0;;
        "mul3d" | "-mul3d" | "+mul3d")
            COMPREPLY=( $(compgen -W "factor factor_x,factor_y,_factor_z") ); return 0;;
        "mul" | "-mul" | "+mul")
            COMPREPLY=( $(compgen -W "value[%] [image] \'formula\' (no_arg)") ); return 0;;
        "multithreaded3d" | "-multithreaded3d" | "+multithreaded3d")
            COMPREPLY=( $(compgen -W "> _is_multi_threaded_rendering={_0:No_|_1:Yes_}") ); return 0;;
        "mv" | "-mv" | "+mv")
            COMPREPLY=( $(compgen -W "> position[%]") ); return 0;;
        "n" | "-n" | "+n")
        ...
        "narg" | "-narg" | "+narg")
            COMPREPLY=( $(compgen -W "> arg_1,arg_2,...,arg_N") ); return 0;;
        ...
        "nn_add" | "-nn_add" | "+nn_add")
            COMPREPLY=( $(compgen -W "> out,in0,in1,_in2,_in3") ); return 0;;
        "nn_append" | "-nn_append" | "+nn_append")
            COMPREPLY=( $(compgen -W "> out,in0,in1,_in2,_in3,axis={_x_|_y_|_z_|_c_}") ); return 0;;
        "nn_check_layer" | "-nn_check_layer" | "+nn_check_layer")
            COMPREPLY=( $(compgen -W "> layer_name") ); return 0;;
        "nn_clone" | "-nn_clone" | "+nn_clone")
            COMPREPLY=( $(compgen -W "> out0,out1,in") ); return 0;;
        "nn_columnpatch2d" | "-nn_columnpatch2d" | "+nn_columnpatch2d")
            COMPREPLY=( $(compgen -W "> out,in,out_width>0,out_height>0,patch_size>0,_overlap>0") ); return 0;;
        "nn_conv2d" | "-nn_conv2d" | "+nn_conv2d")
            COMPREPLY=( $(compgen -W "> out,in,nb_channels>0,_kernel_size>0,_stride>0,_dilation,_shrink>=0,_boundary_conditions,_learning_mode,_weight_decay>=0,_initialization") ); return 0;;
        "nn_conv3d" | "-nn_conv3d" | "+nn_conv3d")
            COMPREPLY=( $(compgen -W "> out,in,nb_channels>0,_kernel_size>0,_stride>0,_dilation,_shrink>=0,_boundary_conditions,_learning_mode,_weight_decay>=0,_initialization") ); return 0;;
        "nn_conv" | "-nn_conv" | "+nn_conv")
            COMPREPLY=( $(compgen -W "> out,in,nb_channels>0,_kernel_width>0,_kernel_height>0,_kernel_depth>0,_stride_x>0,_stride_y>0,_stride_z>0,_dilation_x,_dilation_y,_dilation_z,_shrink_x>=0,_shrink_y>=0_,_shrink_z>=0,boundary_conditions,_learning_mode,_weight_decay>=0,_initialization") ); return 0;;
        "nn_crop" | "-nn_crop" | "+nn_crop")
            COMPREPLY=( $(compgen -W "> out,in,x0,y0,z0,c0,x1,y1,z1,c1,_boundary_conditions") ); return 0;;
        "nn_div" | "-nn_div" | "+nn_div")
            COMPREPLY=( $(compgen -W "> out,in0,in1") ); return 0;;
        "nn_dropout" | "-nn_dropout" | "+nn_dropout")
            COMPREPLY=( $(compgen -W "> out,in,0<=dropout_rate<1") ); return 0;;
        "nn_fc" | "-nn_fc" | "+nn_fc")
            COMPREPLY=( $(compgen -W "> out,in,nb_channels>0,_learning_mode,_weight_decay>=0,_initialization") ); return 0;;
        "nn_fft" | "-nn_fft" | "+nn_fft")
            COMPREPLY=( $(compgen -W "> out,in,io_mode,_is_inverse={_0:No_|_1:Yes_},_axes.") ); return 0;;
        "nn_init" | "-nn_init" | "+nn_init")
            COMPREPLY=( $(compgen -W "> _network_name") ); return 0;;
        "nn_input" | "-nn_input" | "+nn_input")
            COMPREPLY=( $(compgen -W "> out,width,_height,_depth,_spectrum") ); return 0;;
        "nn_linear" | "-nn_linear" | "+nn_linear")
            COMPREPLY=( $(compgen -W "> out,in,nb_channels>0,_axis={_x_|_y_|_z_|_c},_learning_mode,_weight_decay>=0,_initialization") ); return 0;;
        "nn_loss_add" | "-nn_loss_add" | "+nn_loss_add")
            COMPREPLY=( $(compgen -W "> out,in0,in1,...") ); return 0;;
        "nn_loss_bce" | "-nn_loss_bce" | "+nn_loss_bce")
            COMPREPLY=( $(compgen -W "> out,in,ground_truth,_weight") ); return 0;;
        "nn_loss_ce" | "-nn_loss_ce" | "+nn_loss_ce")
            COMPREPLY=( $(compgen -W "> out,in,ground_truth,_weight") ); return 0;;
        "nn_loss_l1" | "-nn_loss_l1" | "+nn_loss_l1")
            COMPREPLY=( $(compgen -W "> out,in,_ground_truth,_weight") ); return 0;;
        "nn_loss_l2" | "-nn_loss_l2" | "+nn_loss_l2")
            COMPREPLY=( $(compgen -W "> out,in,_ground_truth,_weight") ); return 0;;
        "nn_loss_lp" | "-nn_loss_lp" | "+nn_loss_lp")
            COMPREPLY=( $(compgen -W "> out,in,_ground_truth,_p>0,_weight") ); return 0;;
        "nn_loss_mse" | "-nn_loss_mse" | "+nn_loss_mse")
            COMPREPLY=( $(compgen -W "> out,in,_ground_truth,_weight") ); return 0;;
        "nn_loss_sigmoid_bce" | "-nn_loss_sigmoid_bce" | "+nn_loss_sigmoid_bce")
            COMPREPLY=( $(compgen -W "> out,in,ground_truth,_weight") ); return 0;;
        "nn_loss_smoothl1" | "-nn_loss_smoothl1" | "+nn_loss_smoothl1")
            COMPREPLY=( $(compgen -W "> out,in,_ground_truth,_weight") ); return 0;;
        "nn_loss_softmax_ce" | "-nn_loss_softmax_ce" | "+nn_loss_softmax_ce")
            COMPREPLY=( $(compgen -W "> out,in,ground_truth,_weight") ); return 0;;
        "nn_maxpool2d" | "-nn_maxpool2d" | "+nn_maxpool2d")
            COMPREPLY=( $(compgen -W "> out,in,_patch_size>1,_is_maxabs={_0:No_|_1:Yes_}") ); return 0;;
        "nn_maxpool3d" | "-nn_maxpool3d" | "+nn_maxpool3d")
            COMPREPLY=( $(compgen -W "> out,in,_patch_size>1,_is_maxabs={_0:No_|_1:Yes_}") ); return 0;;
        "nn_mmul" | "-nn_mmul" | "+nn_mmul")
            COMPREPLY=( $(compgen -W "> out,in0,in1") ); return 0;;
        "nn_mmult" | "-nn_mmult" | "+nn_mmult")
            COMPREPLY=( $(compgen -W "> out,in0,in1") ); return 0;;
        "nn_mul" | "-nn_mul" | "+nn_mul")
            COMPREPLY=( $(compgen -W "> out,in0,in1,_in2,_in3") ); return 0;;
        "nn_network" | "-nn_network" | "+nn_network")
            COMPREPLY=( $(compgen -W "> _network_name") ); return 0;;
        "nn_nl" | "-nn_nl" | "+nn_nl")
            COMPREPLY=( $(compgen -W "> out,in,_activation") ); return 0;;
        "nn_noise" | "-nn_noise" | "+nn_noise")
            COMPREPLY=( $(compgen -W "> out,in,_amplitude,_noise_type,_training_only={_0:No_|_1:Yes_}") ); return 0;;
        "nn_norm" | "-nn_norm" | "+nn_norm")
            COMPREPLY=( $(compgen -W "> out,in,p>=0,_axis={_0_|_x_|_y_|_z_|_c_}") ); return 0;;
        "nn_normalize" | "-nn_normalize" | "+nn_normalize")
            COMPREPLY=( $(compgen -W "> out,in,axes,_normalization_type={_0:Avg_std_|_1:RMS_},_group_x>=0,_group_y>=0,_group_z>=0,_group_c>=0,_learning_mode") ); return 0;;
        "nn_parameters" | "-nn_parameters" | "+nn_parameters")
            COMPREPLY=( $(compgen -W "> out,width>0,_height>0,_depth>0,_spectrum>0,_learning_mode,_weight_decay>=0,_initialization") ); return 0;;
        "nn_patchcolumn2d" | "-nn_patchcolumn2d" | "+nn_patchcolumn2d")
            COMPREPLY=( $(compgen -W "> out,in,patch_size>0,_overlap>=0") ); return 0;;
        "nn_patchdown2d" | "-nn_patchdown2d" | "+nn_patchdown2d")
            COMPREPLY=( $(compgen -W "> out,in,_patch_size>1") ); return 0;;
        ...
        "nn_patchup3d" | "-nn_patchup3d" | "+nn_patchup3d")
            COMPREPLY=( $(compgen -W "> out,in,_patch_size>1") ); return 0;;
        "nn_permute" | "-nn_permute" | "+nn_permute")
            COMPREPLY=( $(compgen -W "> out,in,permutation") ); return 0;;
        "nn_rename" | "-nn_rename" | "+nn_rename")
            COMPREPLY=( $(compgen -W "> out,in") ); return 0;;
        "nn_reshape" | "-nn_reshape" | "+nn_reshape")
            COMPREPLY=( $(compgen -W "> out,in,width>0,_height>0,_depth>0,_spectrum>0") ); return 0;;
        ...
        "nn_split" | "-nn_split" | "+nn_split")
            COMPREPLY=( $(compgen -W "> out0,out1,_out2,_out3,in,axis={_x_|_y_|_z_|_c_},_size_out0>0,_size_out1>0,_size_out2>0,_size_out3>0") ); return 0;;
        "nn_store" | "-nn_store" | "+nn_store")
            COMPREPLY=( $(compgen -W "> \'variable_name\',_include_trainer_data={_0:No_|_1:Yes_}") ); return 0;;
        "nn_sub" | "-nn_sub" | "+nn_sub")
            COMPREPLY=( $(compgen -W "> out,in0,in1") ); return 0;;
        "nn_sum" | "-nn_sum" | "+nn_sum")
            COMPREPLY=( $(compgen -W "> out,in,_is_average={_0:No_|_1:Yes_},_axis={_0_|_x_|_y_|_z_|_c_}") ); return 0;;
        "nn_tmmul" | "-nn_tmmul" | "+nn_tmmul")
            COMPREPLY=( $(compgen -W "> out,in0,in1") ); return 0;;
        "nn_tmmult" | "-nn_tmmult" | "+nn_tmmult")
            COMPREPLY=( $(compgen -W "> out,in0,in1") ); return 0;;
        "nn_trainer" | "-nn_trainer" | "+nn_trainer")
            COMPREPLY=( $(compgen -W "> out,loss,_optimizer,_\"optimizer_params\",_scheduler,_\"scheduler_params\"") ); return 0;;
        "nn_transpose" | "-nn_transpose" | "+nn_transpose")
            COMPREPLY=( $(compgen -W "> out,in") ); return 0;;
        "nn_varname" | "-nn_varname" | "+nn_varname")
            COMPREPLY=( $(compgen -W "> layer_name") ); return 0;;
        "noise" | "-noise" | "+noise")
        ...
        "normalize_local" | "-normalize_local" | "+normalize_local")
            COMPREPLY=( $(compgen -W "> _amplitude>=0,_radius>0,_n_smooth[%]>=0,_a_smooth[%]>=0,_is_cut={_0:No_|_1:Yes_},_min=0,_max=255") ); return 0;;
        "normalized_cross_correlation" | "-normalized_cross_correlation" | "+normalized_cross_correlation")
            COMPREPLY=( $(compgen -W "> [mask]") ); return 0;;
        "normalmap3d" | "-normalmap3d" | "+normalmap3d")
            COMPREPLY=( $(compgen -W "> [object3d],_x[%],_y[%],_z_,is_double_sided={_0:No_|_1:Yes_},_is_zbuffer={_0:No_|_1:Yes_},_focale") ); return 0;;
        "normals3d" | "-normals3d" | "+normals3d")
            COMPREPLY=( $(compgen -W "> output_mode={_0:vertices_|_1:primitives_|_2:vertices+primitives_}.") ); return 0;;
        "normp" | "-normp" | "+normp")
        ...
        "otsu" | "-otsu" | "+otsu")
            COMPREPLY=( $(compgen -W "> _nb_levels>0") ); return 0;;
        "ox" | "-ox" | "+ox")
            COMPREPLY=( $(compgen -W "> extension1,_extension2,_...,_extensionN,_output_at_same_location={_0:No_|_1:Yes_}") ); return 0;;
        "p3d" | "-p3d" | "+p3d")
            COMPREPLY=( $(compgen -W "> mode") ); return 0;;
        "pack" | "-pack" | "+pack")
            COMPREPLY=( $(compgen -W "> is_ratio_constraint={_0:No_|_1:Yes_},_sort_criterion") ); return 0;;
        "pack_sprites" | "-pack_sprites" | "+pack_sprites")
            COMPREPLY=( $(compgen -W "> [sprite_set],_nb_scales>=1,0<_min_scale<=100,_allow_rotation={_0:None_|_1:180_deg._|_2:90_deg._|_3:Any_},_spacing,_max_attempts>0") ); return 0;;
        "palette" | "-palette" | "+palette")
            COMPREPLY=( $(compgen -W "> palette_name_|_palette_number") ); return 0;;
        "parallel" | "-parallel" | "+parallel")
            COMPREPLY=( $(compgen -W "> _wait_threads,\"command_1\",\"command_2\",...") ); return 0;;
        ...
        "path_cached_file" | "-path_cached_file" | "+path_cached_file")
            COMPREPLY=( $(compgen -W "> \"filename\"") ); return 0;;
        "pca" | "-pca" | "+pca")
            COMPREPLY=( $(compgen -W "> _output_mode,_target_dim[%]>0,_normalization_mode={_0:None_|_1:Center_|_2:Center+scale_}") ); return 0;;
        "pca_patch3d" | "-pca_patch3d" | "+pca_patch3d")
            COMPREPLY=( $(compgen -W "> _patch_size>0,_M>0,_N>0,_normalize_input={_0:No_|_1:Yes_},_normalize_output={_0:No_|_1:Yes_},_lambda_xy") ); return 0;;
        "pde_flow" | "-pde_flow" | "+pde_flow")
            COMPREPLY=( $(compgen -W "> _nb_iter>=0,_dt,_velocity_command,_keep_sequence={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "permute" | "-permute" | "+permute")
            COMPREPLY=( $(compgen -W "> permutation") ); return 0;;
        "peronamalik_flow" | "-peronamalik_flow" | "+peronamalik_flow")
            COMPREPLY=( $(compgen -W "> K_factor>0,_nb_iter>=0,_dt,_keep_sequence={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "pixelsort" | "-pixelsort" | "+pixelsort")
            COMPREPLY=( $(compgen -W "> _ordering={_+:Increasing_|_-:Decreasing_},_axis={_x_|_y_|_z_|_xy_|_yx_},_[sorting_criterion],_[mask]") ); return 0;;
        ...
        "plot" | "-plot" | "+plot")
            COMPREPLY=( $(compgen -W "> _plot_type,_vertex_type,_xmin,_xmax,_ymin,_ymax,_exit_on_anykey={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "projections3d" | "-projections3d" | "+projections3d")
            COMPREPLY=( $(compgen -W "> _x[%],_y[%],_z[%],_is_bounding_box={_0:No_|_1:Yes_},nb_subdivisions>0") ); return 0;;
        ...
        "qr" | "-qr" | "+qr")
            COMPREPLY=( $(compgen -W "> _is_reduced_form={_0:No_|_1:Yes_}") ); return 0;;
        "quadrangle3d" | "-quadrangle3d" | "+quadrangle3d")
            COMPREPLY=( $(compgen -W "> x0,y0,z0,x1,y1,z1,x2,y2,z2,x3,y3,z3") ); return 0;;
        "quantize" | "-quantize" | "+quantize")
            COMPREPLY=( $(compgen -W "> nb_levels>=1,_keep_values={_0:No_|_1:Yes_},_quantization_type={_-1:Median-cut_|_0:K-means_|_1:Uniform_}") ); return 0;;
        "quantize_area" | "-quantize_area" | "+quantize_area")
            COMPREPLY=( $(compgen -W "> _min_area>0") ); return 0;;
        "quiver" | "-quiver" | "+quiver")
            COMPREPLY=( $(compgen -W "> [function_image],_sampling[%]>0,_factor>=0,_is_arrow={_0:No_|_1:Yes_},_opacity,_color1,...") ); return 0;;
        "r3d" | "-r3d" | "+r3d")
        ...
        "random_patches" | "-random_patches" | "+random_patches")
            COMPREPLY=( $(compgen -W "> _nb_patches>0,_patch_size>0") ); return 0;;
        ...
        "replace_infnan" | "-replace_infnan" | "+replace_infnan")
            COMPREPLY=( $(compgen -W "> _expression") ); return 0;;
        ...
        "resize_displacement" | "-resize_displacement" | "+resize_displacement")
            COMPREPLY=( $(compgen -W "> width[%]>0,_height[%]>0,_depth[%]>0") ); return 0;;
        ...
        "rgb2xyz" | "-rgb2xyz" | "+rgb2xyz")
            COMPREPLY=( $(compgen -W "illuminant={_0:D50_|_1:D65_|_2:E_} (no_arg)") ); return 0;;
        "rgb" | "-rgb" | "+rgb")
            COMPREPLY=( $(compgen -W "_min_RGB_value,_max_RGB_value (no_arg)") ); return 0;;
        "rgba" | "-rgba" | "+rgba")
            COMPREPLY=( $(compgen -W "_min_RGB_value,_max_RGB_value,_min_A_value,_max_A_value (no_arg)") ); return 0;;
        "ri" | "-ri" | "+ri")
            COMPREPLY=( $(compgen -W "> [reference],_interpolation,_boundary_conditions,_ax,_ay,_az,_ac") ); return 0;;
        ...
        "s" | "-s" | "+s")
            COMPREPLY=( $(compgen -W "{_x_|_y_|_z_|_c_}...{_x_|_y_|_z_|_c_},_split_mode[%],_max_parts>0 keep_splitting_values={_+:Increasing_|_-:Decreasing_},_{_x_|_y_|_z_|_c_}...{_x_|_y_|_z_|_c_},value1,_value2,... (no_arg)") ); return 0;;
        ...
        "scale_dcci2x" | "-scale_dcci2x" | "+scale_dcci2x")
            COMPREPLY=( $(compgen -W "> _edge_threshold>=0,_exponent>0,_extend_1px={_0:No_|_1:Yes_}") ); return 0;;
        "scanlines" | "-scanlines" | "+scanlines")
            COMPREPLY=( $(compgen -W "> _amplitude,_bandwidth,_shape={_0:Block_|_1:Triangle_|_2:Sine_|_3:Sine+_|_4:Random_},_angle,_offset") ); return 0;;
        "screen" | "-screen" | "+screen")
            COMPREPLY=( $(compgen -W "> _x0[%],_y0[%],_x1[%],_y1[%]") ); return 0;;
        "seamcarve" | "-seamcarve" | "+seamcarve")
            COMPREPLY=( $(compgen -W "> _width[%]>=0,_height[%]>=0,_is_priority_channel={_0:No_|_1:Yes_},_is_antialiasing={_0:No_|_1:Yes_},_maximum_seams[%]>=0") ); return 0;;
        "segment_watershed" | "-segment_watershed" | "+segment_watershed")
            COMPREPLY=( $(compgen -W "> _threshold>=0") ); return 0;;
        "select" | "-select" | "+select")
            COMPREPLY=( $(compgen -W "> feature_type,_X[%]>=0,_Y[%]>=0,_Z[%]>=0,_exit_on_anykey={_0:No_|_1:Yes_},_is_multiaxes_selection={_0:No_|_1:Yes_}") ); return 0;;
        "select_color" | "-select_color" | "+select_color")
            COMPREPLY=( $(compgen -W "> tolerance[%]>=0,col1,...,colN") ); return 0;;
        "serialize" | "-serialize" | "+serialize")
            COMPREPLY=( $(compgen -W "> _datatype,_is_compressed={_0:No_|_1:Yes_},_store_names={_0:No_|_1:Yes_}") ); return 0;;
        "set" | "-set" | "+set")
            COMPREPLY=( $(compgen -W "> value,_x[%],_y[%],_z[%],_c[%]") ); return 0;;
        "sh" | "-sh" | "+sh")
        ...
        "shape_heart" | "-shape_heart" | "+shape_heart")
            COMPREPLY=( $(compgen -W "> _size>=0") ); return 0;;
        "shape_hilbert" | "-shape_hilbert" | "+shape_hilbert")
            COMPREPLY=( $(compgen -W "> _size>=0,_nb_recursions>=0") ); return 0;;
        ...
        "shape_rays" | "-shape_rays" | "+shape_rays")
            COMPREPLY=( $(compgen -W "> _size>=0,_xcenter[%],_ycenter[%],_branches>0,_angle[%],_twist,0<=_perspective<=1,_is_antialias={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "skeleton3d" | "-skeleton3d" | "+skeleton3d")
            COMPREPLY=( $(compgen -W "> _metric,_frame_type={_0:Squares_|_1:Diamonds_|_2:Circles_|_3:Auto_},_skeleton_opacity,_frame_opacity,_is_frame_wireframe={_0:No_|_1:Yes_}") ); return 0;;
        "skeleton" | "-skeleton" | "+skeleton")
            COMPREPLY=( $(compgen -W "> _boundary_conditions={_0:Dirichlet_|_1:Neumann_}") ); return 0;;
        "sketchbw" | "-sketchbw" | "+sketchbw")
            COMPREPLY=( $(compgen -W "> _nb_angles>0,_start_angle,_angle_range>=0,_length>=0,_threshold>=0,_opacity,_bgfactor>=0,_density>0,_sharpness>=0,_anisotropy>=0,_smoothness>=0,_coherence>=0,_is_boost={_0:No_|_1:Yes_},_is_curved={_0:No_|_1:Yes_}") ); return 0;;
        "skip" | "-skip" | "+skip")
        ...
        "smooth" | "-smooth" | "+smooth")
            COMPREPLY=( $(compgen -W "amplitude[%]>=0,_sharpness>=0,0<=_anisotropy<=1,_alpha[%],_sigma[%],_dl>0,_da>0,_precision>0,_interpolation,_fast_approx={_0:No_|_1:Yes_} nb_iterations>=0,_sharpness>=0,_anisotropy,_alpha,_sigma,_dt>0,0 [tensor_field],_amplitude>=0,_dl>0,_da>0,_precision>0,_interpolation,_fast_approx={_0:No_|_1:Yes_} [tensor_field],_nb_iters>=0,_dt>0,0") ); return 0;;
        ...
        "sort" | "-sort" | "+sort")
            COMPREPLY=( $(compgen -W "> _ordering={_+:Increasing_|_-:Decreasing_},_axis={_x_|_y_|_z_|_c_}") ); return 0;;
        "sort_list" | "-sort_list" | "+sort_list")
            COMPREPLY=( $(compgen -W "> _ordering={_+:Increasing_|_-:Decreasing_},_criterion") ); return 0;;
        "sp" | "-sp" | "+sp")
            COMPREPLY=( $(compgen -W "_name1={_?_|_apples_|_balloons_|_barbara_|_boats_|_bottles_|_butterfly_|_cameraman_|_car_|_cat_|_cliff_|_chick_|_colorful_|_david_|_dog_|_duck_|_eagle_|_elephant_|_earth_|_flower_|_fruits_|_gmicky_|_gmicky_mahvin_|_gmicky_wilber_|_greece_|_gummy_|_house_|_inside_|_landscape_|_leaf_|_lena_|_leno_|_lion_|_mandrill_|_monalisa_|_monkey_|_parrots_|_pencils_|_peppers_|_portrait0_|_portrait1_|_portrait2_|_portrait3_|_portrait4_|_portrait5_|_portrait6_|_portrait7_|_portrait8_|_portrait9_|_roddy_|_rooster_|_rose_|_square_|_swan_|_teddy_|_tiger_|_tulips_|_wall_|_waterfall_|_zelda_},_name2,...,_nameN,_width={_>=0_|_0_(auto)_},_height_=_{_>=0_|_0_(auto)_} (no_arg)") ); return 0;;
        ...
        "spiralbw" | "-spiralbw" | "+spiralbw")
            COMPREPLY=( $(compgen -W "> width>0,_height>0,_is_2dcoords={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "split_tiles" | "-split_tiles" | "+split_tiles")
            COMPREPLY=( $(compgen -W "> M!=0,_N!=0,_is_homogeneous={_0:No_|_1:Yes_}") ); return 0;;
        "split_vector" | "-split_vector" | "+split_vector")
            COMPREPLY=( $(compgen -W "> keep_splitting_values={_+:Increasing_|_-:Decreasing_},value1,_value2,...") ); return 0;;
        "sponge" | "-sponge" | "+sponge")
            COMPREPLY=( $(compgen -W "> _size>0") ); return 0;;
        "spread" | "-spread" | "+spread")
            COMPREPLY=( $(compgen -W "> _dx[%]>=0,_dy[%]>=0,_dz[%]>=0") ); return 0;;
        "sprites3d" | "-sprites3d" | "+sprites3d")
            COMPREPLY=( $(compgen -W "> [sprite],_sprite_has_alpha_channel={_0:No_|_1:Yes_}") ); return 0;;
        "srand" | "-srand" | "+srand")
        ...
        "ssd_patch" | "-ssd_patch" | "+ssd_patch")
            COMPREPLY=( $(compgen -W "> [patch],_use_fourier={_0:No_|_1:Yes_},_boundary_conditions") ); return 0;;
        "ssim" | "-ssim" | "+ssim")
        ...
        "stained_glass" | "-stained_glass" | "+stained_glass")
            COMPREPLY=( $(compgen -W "> _edges[%]>=0,_shading>=0,_is_thin_separators={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "store" | "-store" | "+store")
            COMPREPLY=( $(compgen -W "> _is_compressed={_0:No_|_1:Yes_},variable_name1,_variable_name2,...") ); return 0;;
        "str2hex" | "-str2hex" | "+str2hex")
            COMPREPLY=( $(compgen -W "> \"string\"") ); return 0;;
        "str" | "-str" | "+str")
            COMPREPLY=( $(compgen -W "> string") ); return 0;;
        "strbuffer" | "-strbuffer" | "+strbuffer")
            COMPREPLY=( $(compgen -W "> buffer_size") ); return 0;;
        ...
        "streamline3d" | "-streamline3d" | "+streamline3d")
            COMPREPLY=( $(compgen -W "x[%],y[%],z[%],_L>=0,_dl>0,_interpolation,_is_backward={_0:No_|_1:Yes_},_is_oriented={_0:No_|_1:Yes_} \'formula\',x,y,z,_L>=0,_dl>0,_interpolation,_is_backward={_0:No_|_1:Yes_},_is_oriented={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "symmetrize" | "-symmetrize" | "+symmetrize")
            COMPREPLY=( $(compgen -W "> _x[%],_y[%],_angle,_boundary_conditions={_0:Dirichlet_|_1:Neumann_|_2:Periodic_|_3:Mirror_},_is_antisymmetry={_0:No_|_1:Yes_},_swap_sides={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "thickcircle" | "-thickcircle" | "+thickcircle")
            COMPREPLY=( $(compgen -W "> x[%],y[%],R[%],_thickness>=0,_opacity,_color1,...") ); return 0;;
        "thickellipse" | "-thickellipse" | "+thickellipse")
            COMPREPLY=( $(compgen -W "> x[%],y[%],R[%],r[%],_angle,_thickness>=0,_opacity,_color1,...") ); return 0;;
        "thickline" | "-thickline" | "+thickline")
            COMPREPLY=( $(compgen -W "> x0[%],y0[%],x1[%],y1[%],_thickness,_opacity,_color1") ); return 0;;
        "thickpolygon" | "-thickpolygon" | "+thickpolygon")
            COMPREPLY=( $(compgen -W "N>=1,x1[%],y1[%],...,xN[%],yN[%],_thickness>=0,_opacity,_color1,... [coords],_thickness>=0,_opacity,_color1,...") ); return 0;;
        ...
        "threshold" | "-threshold" | "+threshold")
            COMPREPLY=( $(compgen -W "> value[%],_is_soft_thresholding={_0:No_|_1:Yes_}") ); return 0;;
        "to" | "-to" | "+to")
            COMPREPLY=( $(compgen -W "> text,_x[%|~],_y[%|~],{__font_height[%]>0_|_custom_font_},_outline>=0,_opacity,_color1,...") ); return 0;;
        ...
        "to_pseudogray" | "-to_pseudogray" | "+to_pseudogray")
            COMPREPLY=( $(compgen -W "> _max_step>=0,_is_perceptual_constraint={_0:No_|_1:Yes_},_bits_depth>0") ); return 0;;
        "tones" | "-tones" | "+tones")
        ...
        "transition3d" | "-transition3d" | "+transition3d")
            COMPREPLY=( $(compgen -W "> _nb_frames>=2,_nb_xtiles>0,_nb_ytiles>0,_axis_x,_axis_y,_axis_z,_is_antialias={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "turbulence" | "-turbulence" | "+turbulence")
            COMPREPLY=( $(compgen -W "> _radius>0,_octaves={_1,2,3...,12_},_alpha>0,_difference={_-10,10_},_mode={_0,1,2,3_}") ); return 0;;
        ...
        "unitnorm" | "-unitnorm" | "+unitnorm")
            COMPREPLY=( $(compgen -W "> _p>=0") ); return 0;;
        ...
        "volumetric2d" | "-volumetric2d" | "+volumetric2d")
            COMPREPLY=( $(compgen -W "> _x[%],_y[%],_z[%],_separator_size>=0") ); return 0;;
        "voxelize3d" | "-voxelize3d" | "+voxelize3d")
            COMPREPLY=( $(compgen -W "> _max_resolution>0,_fill_interior={_0:No_|_1:Yes_},_preserve_colors={_0:No_|_1:Yes_}") ); return 0;;
        "w" | "-w" | "+w")
        ...
        "warn" | "-warn" | "+warn")
            COMPREPLY=( $(compgen -W "> _force_visible={_0:No_|_1:Yes_},_message") ); return 0;;
        "warp" | "-warp" | "+warp")
        ...
        "warp_patch" | "-warp_patch" | "+warp_patch")
            COMPREPLY=( $(compgen -W "> [displacement_map],patch_width>=1,_patch_height>=1,_patch_depth>=1,_std_factor>0,_boundary_conditions,_fast_approximation={_0:No_|_1:Yes_}") ); return 0;;
        ...
        "watershed" | "-watershed" | "+watershed")
            COMPREPLY=( $(compgen -W "> [priority_image],_is_high_connectivity={_0:No_|_1:Yes_}") ); return 0;;
        "wave" | "-wave" | "+wave")
        ...
        "x_colorize" | "-x_colorize" | "+x_colorize")
            COMPREPLY=( $(compgen -W "> _is_lineart={_0:No_|_1:Yes_},_max_resolution={_0_|_>=128_},_multichannels_output={_0:No_|_1:Yes_},_[palette1],_[palette2],_[grabber1]") ); return 0;;
        ...
        "x_mandelbrot" | "-x_mandelbrot" | "+x_mandelbrot")
            COMPREPLY=( $(compgen -W "> _is_julia={_0:No_|_1:Yes_},_c0r,_c0i") ); return 0;;
        ...
        "x_segment" | "-x_segment" | "+x_segment")
            COMPREPLY=( $(compgen -W "> _max_resolution={_0:Auto_|_>=128_}") ); return 0;;
